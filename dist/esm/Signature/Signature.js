...
var Signature = function Signature(_ref) {
  var _ref$historyUrl = _ref.historyUrl,
    historyUrl = _ref$historyUrl === void 0 ? false : _ref$historyUrl,
    _ref$historyParams = _ref.historyParams,
    historyParams = _ref$historyParams === void 0 ? {} : _ref$historyParams,
    _ref$showBtn = _ref.showBtn,
    showBtn = _ref$showBtn === void 0 ? true : _ref$showBtn,
    onConfirm = _ref.onConfirm,
    _ref$width = _ref.width,
    width = _ref$width === void 0 ? 820 : _ref$width,
    _ref$height = _ref.height,
    height = _ref$height === void 0 ? 300 : _ref$height,
    _ref$needPreview = _ref.needPreview,
    needPreview = _ref$needPreview === void 0 ? true : _ref$needPreview,
    _ref$needPrint = _ref.needPrint,
    needPrint = _ref$needPrint === void 0 ? true : _ref$needPrint;
  ...
  var _useState3 = useState([]),
    ...
    drawingSteps = _useState4[0],
    setDrawingSteps = _useState4[1];
  ...
  //历史签名
  var historyImgChange = /*#__PURE__*/ (function () {
    var _ref2 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(e) {
        var canvas, context, img, tmp;
          ...
          while (1)
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                tmp = localStorage.getItem('tmpUrl');
    ...
    return function historyImgChange(_x) {
      return _ref2.apply(this, arguments);
    };
  })();
  var handleMouseMove = function handleMouseMove(e) {
    var _colorPickerRef$curre;
    var colors =
      (_colorPickerRef$curre = colorPickerRef.current) === null || _colorPickerRef$curre === void 0
        ? void 0
        : _colorPickerRef$curre.color;
    if (!isDrawing) return;
    var canvas = canvasRef.current;
    var context = canvas.getContext('2d');
    var newX = e.nativeEvent.offsetX;
    var newY = e.nativeEvent.offsetY;
    context.beginPath();
    ...
    setLastY(newY);
    setDrawingSteps(
      [].concat(_toConsumableArray(drawingSteps), [
        {
          lastX: lastX,
          lastY: lastY,
          newX: newX,
  ...
  //上一步
  var undoStep = function undoStep(e) {
    e.preventDefault();
    if (drawingSteps.length > 0) {
      var canvas = canvasRef.current;
      var context = canvas.getContext('2d');
      var lastStep = drawingSteps[drawingSteps.length - 1];
      context.clearRect(0, 0, width, height);
      drawingSteps.slice(0, -1).forEach(function (step) {
        context.beginPath();
  ...
  // 生成图片预览/确定
  var generateOk = function generateOk(e) {
    e.preventDefault();
    var canvas = canvasRef.current;
    var tmpImg = canvas.toDataURL();
  ...
  // 清除
  var clearAll = function clearAll(e) {
    e.preventDefault();
    var canvas = canvasRef.current;
    var context = canvas.getContext('2d');
    context.clearRect(0, 0, width, height);
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    showBtn &&
      /*#__PURE__*/ React.createElement(
        'div',
        null,
        /*#__PURE__*/ isValidElement(showBtn)
          ? showBtn
